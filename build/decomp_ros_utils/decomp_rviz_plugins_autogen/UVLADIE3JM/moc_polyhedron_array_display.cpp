...
#include "../../../../src/Utils/DecompROS/decomp_ros_utils/src/polyhedron_array_display.h"
...
void decomp_rviz_plugins::PolyhedronArrayDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PolyhedronArrayDisplay *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject decomp_rviz_plugins::PolyhedronArrayDisplay::staticMetaObject = { {
    &rviz::MessageFilterDisplay<decomp_ros_msgs::PolyhedronArray>::staticMetaObject,
    qt_meta_stringdata_decomp_rviz_plugins__PolyhedronArrayDisplay.data,
    qt_meta_data_decomp_rviz_plugins__PolyhedronArrayDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
