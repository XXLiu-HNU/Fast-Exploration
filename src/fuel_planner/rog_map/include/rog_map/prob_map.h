...
namespace rog_map {
    ...
    public:
        ...
        // Expose map pointers for external access (e.g., plan_env adapter)
        ESDFMap::Ptr getESDFMap() const { return esdf_map_; }
        InfMap::Ptr getInfMap() const { return inf_map_; }
        FreeCntMap::Ptr getFreeCntMap() const { return fcnt_map_; }
